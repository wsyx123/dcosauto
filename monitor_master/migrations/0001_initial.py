# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-04-09 01:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ManyToManyField(to='monitor_master.MonitorItem', verbose_name='\u76d1\u63a7\u9879')),
                ('policy', models.ManyToManyField(to='monitor_master.MonitorNotifyPolicy', verbose_name='\u544a\u8b66\u7b56\u7565')),
            ],
        ),
        migrations.AddField(
            model_name='monitorhost',
            name='template',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='monitor_master.MonitorTemplate', verbose_name='\u6a21\u7248'),
        ),
    ]
