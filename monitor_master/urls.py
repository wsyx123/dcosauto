...
from .views import HostViewSet,DetailViewSet,PolicyViewSet,\
ProblemViewSet,TemplateViewSet,ItemViewSet,ConfigViewSet,NotifyConfigViewSet
...
router.register(r'notifys',NotifyConfigViewSet)
